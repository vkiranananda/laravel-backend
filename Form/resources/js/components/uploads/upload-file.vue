        ...
        <div v-else>
            ...
            <div class="conteiner">
                <div class='media-file' v-for="file in files" :key="file.id">
                    ...
                    <div :class="{ 'have-errors': file.haveErrors, 'selected': file.selected }" class="media-file-body"
                         @click="selectFile(file)">
                        <img :src="file.thumb" alt="">
                        <div class="text" data-type="text" v-if="file.file_type != 'image'">{{ file.orig_name }}</div>
                        <progress v-show="!file.id && !file.haveErrors" class="progress progress-info"
                                  :value="file.progress" max="100"></progress>
                    </div>
                </div>
            </div>
