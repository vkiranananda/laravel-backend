<template>
	<vue-multiselect class="form-control" :class='error ? "is-invalid" : "" ' v-model="value" :options="field.options"  :multiple="field.multiple" track-by="value" label="label" :placeholder="placeholder" :showLabels="false"></vue-multiselect>
</template>
