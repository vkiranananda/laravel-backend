...
Поле для редактирования текста с использованием блоков.
...
- `styled-text` - стилизованный текст, массив стилей, в каждом элементе указывается класс `className` со стилем, `label` - название в списке
