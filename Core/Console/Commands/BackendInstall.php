...
class BackendInstall extends Command
{
    ...
    public function printHelp()
    {
        ...
        $this->line("npm install mitt jquery @popperjs/core bootstrap trumbowyg-3 vue-trumbowyg lodash.clonedeep lodash.size vue vuex vue-multiselect vue-the-mask vue2-datepicker vuedraggable fecha @primer/octicons vue-simplemde simplemde-theme-base\n");
        $this->info("В файл webpack.mix.js добавялем строки:");
        $this->line("mix.js('vendor/vkiranananda/backend/resources/js/backend.js', 'public/backend/js/admin.js').vue({ version: 2 }).version();"
