...
class Helpers
{
    ...
    // Ищем по опциям (value) можно передать и простой массив,тогда будет искаться по значению. Первый параметр список опиций, второй искомая строка или массив значний
